    ...
    public class XLua_Gen_Initer_Register__
	{
	    static XLua_Gen_Initer_Register__()
        {
		    XLua.LuaEnv.AddIniter((luaenv, translator) => {
				...
				translator.DelayWrapLoader(typeof(ETest), ETestWrap.__Register);
				
				translator.DelayWrapLoader(typeof(YY.LoadManager), YYLoadManagerWrap.__Register);
				
				translator.DelayWrapLoader(typeof(YY.LuaManager), YYLuaManagerWrap.__Register);
				
				translator.DelayWrapLoader(typeof(YY.Util), YYUtilWrap.__Register);
